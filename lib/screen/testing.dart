...
import 'package:koda_score_webapp/services/firebase_services.dart';
import 'package:koda_score_webapp/services/sheet.dart';
import 'package:koda_score_webapp/utils/button.dart';
...
class Testing extends StatefulWidget {
  Testing({Key? key, required final this.snapshot}) : super(key: key);
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Image.network(
                        'http://20.219.195.58/api${viewImage.toString()}'),
                  ),
                ],
              ),
            ),
